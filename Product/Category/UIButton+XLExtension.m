...
{
    [self addTarget:self action:@selector(buttionAction:) forControlEvents:UIControlEventTouchUpInside];
    objc_setAssociatedObject(self, &ButtonBlockKey, buttonBlock, OBJC_ASSOCIATION_COPY);
}
- (void)buttonBlock:(void (^)(UIButton *))buttonBlock forControlEvents:(UIControlEvents)forControlEvents
{
    [self addTarget:self action:@selector(buttionAction:) forControlEvents:forControlEvents];
    objc_setAssociatedObject(self, &ButtonBlockKey, buttonBlock, OBJC_ASSOCIATION_COPY);
}

- (void (^)(UIButton *))buttonBlock
{
