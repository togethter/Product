...
/*工具------用来计算动态cell高度-------**/
+ (CGFloat)dynamiXLellHeightForStatiXLell:(XLBaseTableViewCell *)cell data:(id)data cellClass:(Class)cellClass tableViewWidth:(CGFloat)width fromXib:(BOOL)isFromXib;
