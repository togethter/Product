...
@class XLTableDataSource;

//view
typedef UIView*(^ViewForHeaderInSection)(UITableView *tableView,NSInteger section,XLTableSectionDataItem *item);
typedef UIView*(^ViewForFooterInSection)(UITableView *tableView,NSInteger section,XLTableSectionDataItem *item);
...
@interface XLTableViewDelegate : NSObject<UITableViewDelegate>
